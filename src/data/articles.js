...
<h2>Πόσο κοστίζει;</h2>
<p>Στη Everyweb, προσφέρουμε πλήρη κατασκευή ιστοσελίδας από <strong>29,99€/μήνα + ΦΠΑ</strong> — με domain, hosting και συντήρηση περιλαμβανόμενα. Κανένα αρχικό κόστος κατασκευής. <a href="/epikoinwnia">Επικοινωνήστε μαζί μας</a> για να ξεκινήσουμε.</p>
    `.trim(),
  },
  {
    slug: 'ti-perilamvanei-to-syndromitiko-paketo-Everyweb',
    lang: 'el',
    title: 'Τι περιλαμβάνει το συνδρομητικό πακέτο της Everyweb',
    excerpt:
    ...
    body: `
<p>Η Everyweb δεν χρεώνει χιλιάδες ευρώ για κατασκευή ιστοσελίδας. Αντ' αυτού, προσφέρουμε ένα <strong>συνδρομητικό μοντέλο</strong> που περιλαμβάνει τα πάντα σε μία μηνιαία χρέωση — 29,99€ + ΦΠΑ.</p>
...
<p>Στη Everyweb, η καταχώρηση και ανανέωση του domain περιλαμβάνεται στο μηνιαίο πακέτο σας. Δεν χρειάζεται να ασχοληθείτε με registrars, DNS ή τεχνικές ρυθμίσεις. <a href="/epikoinwnia">Επικοινωνήστε μαζί μας</a> και φροντίζουμε εμείς.</p>
    `.trim(),
  },
  {
...
<h2>Ξεκινήστε εύκολα με τη Everyweb</h2>
...
<p>Στη Everyweb, κατασκευάζουμε custom ιστοσελίδες γιατί πιστεύουμε στην ταχύτητα, την ασφάλεια και τον καθαρό κώδικα. Και επειδή αναλαμβάνουμε τη συντήρηση, δεν χρειάζεται να ανησυχείτε για ενημερώσεις ή ευπάθειες. <a href="/ypiresies">Δείτε τα πακέτα μας</a>.</p>
    `.trim(),
  },
  {
...
<p>Στη Everyweb, κάθε ιστοσελίδα που κατασκευάζουμε περιλαμβάνει SEO βελτιστοποίηση εξ αρχής. <a href="/epikoinwnia">Επικοινωνήστε μαζί μας</a> για να ξεκινήσουμε.</p>
    `.trim(),
  },
  {
...
<p>Στη Everyweb, δεν κατασκευάζουμε απλά ιστοσελίδες — σας βοηθάμε να κατανοήσετε πώς αποδίδουν και πώς μπορούν να γίνουν καλύτερες. <a href="/epikoinwnia">Επικοινωνήστε μαζί μας</a>.</p>
    `.trim(),
  },
  {
...
<p>Η λύση είναι απλή: χρειάζεστε έναν πιστοποιημένο πάροχο ηλεκτρονικής τιμολόγησης που αναλαμβάνει τη διαβίβαση αυτόματα. Στη Everyweb, προσφέρουμε πλήρη αυτοματισμό τιμολόγησης μέσω πιστοποιημένου παρόχου (etimologiera) από <strong>19,99€/μήνα + ΦΠΑ</strong>. <a href="/ypiresies">Δείτε τις υπηρεσίες μας</a> ή <a href="/epikoinwnia">επικοινωνήστε μαζί μας</a>.</p>
    `.trim(),
  },
  {
...
<p>Αντί να στέλνετε χειροκίνητα κάθε παραστατικό, μπορείτε να αυτοματοποιήσετε πλήρως τη διαδικασία. Στη Everyweb, κάθε πληρωμή μέσω Stripe εκδίδει αυτόματα παραστατικό, το στέλνει στο MyData και αποστέλλει PDF στον πελάτη — χωρίς καμία χειροκίνητη παρέμβαση. <a href="/ypiresies">Μάθετε περισσότερα</a>.</p>
    `.trim(),
  },
  {
...
<p>Η <strong>etimologiera</strong> (Bratnet) είναι αυτή τη στιγμή ο οικονομικότερος πιστοποιημένος πάροχος στην ελληνική αγορά. Σε συνδυασμό με τον αυτοματισμό που προσφέρουμε στη Everyweb, παίρνετε πλήρη λύση τιμολόγησης χωρίς να χρειάζεται να ασχοληθείτε εσείς με τίποτα.</p>

<h2>Τι προσφέρουμε εμείς</h2>
<p>Η υπηρεσία ηλεκτρονικής τιμολόγησης της Everyweb (<strong>19,99€/μήνα + ΦΠΑ</strong>) περιλαμβάνει:</p>
<ul>
