...
export default function AthensView() {
  ...
  return (
    <ProjectPage
      title="Athens View"
      description="Η φωτογράφιση ενός μοντέρνου Airbnb στο κέντρο της Αθήνας επικεντρώνεται στην ανάδειξη της κομψής του αρχιτεκτονικής, της άπλετης φυσικής φωτεινότητας των εσωτερικών χώρων και της εντυπωσιακής θέας προς την Ακρόπολη."
      images={IMAGES}
      seoTitle={seo.title}
