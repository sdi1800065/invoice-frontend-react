...
export default function CretanFleur() {
  ...
  return (
    <ProjectPage
      title="Cretan Fleur"
      description="Η φωτογράφιση ενός μοντέρνου, ηλιολουστού σπιτιού στην Ελαφόνησο στοχεύει στην ανάδειξη της κομψής αρχιτεκτονικής του, της φωτεινότητας των εσωτερικών του χώρων και της μαγευτικής του θέας"
      images={IMAGES}
      seoTitle={seo.title}
